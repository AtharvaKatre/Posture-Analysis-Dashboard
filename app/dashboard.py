...
from app.engine.PoseEstimation import poseDetector
...
mydir = "..//app//assets//model_runtime_output"
filelist = [f for f in os.listdir(mydir) if f.endswith(".gif")]
for f in filelist:
...
def show_output(nClicks, url, start, duration, detectionCon, trackingCon):
    ...
    if nClicks:
        ...
        print(filename)
        with imageio.get_writer("..//app//assets//model_runtime_output/output{}.gif".format(filename), mode="I") as writer:
            for frame in frames:
